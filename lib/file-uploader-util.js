 ...
 */
var validateSubmission = function validateSubmission(submission, submissionFormat, baseOptions) {
  ...
  return rp.post(validateSubmissionOptions).then(function (body) {
 ...
 * @return {Object}
 */
var getExistingSubmission = function getExistingSubmission(submission, baseOptions) {
  var queryParams = {};
  ...
  return rp.get(getSubmissionsOptions).then(function (body) {
 ...
 * @return {Object}
 */
var putMeasurementSet = function putMeasurementSet(measurementSet, baseOptions, measurementSetId) {
  ...
  return rp.put(putMeasurementSetOptions).then(function (body) {
 ...
 * @return {Object}
 */
var postMeasurementSet = function postMeasurementSet(measurementSet, baseOptions) {
  var postMeasurementSetOptions = Object.assign({}, baseOptions, {
    url: baseOptions.url + '/measurement-sets',
    body: JSON.stringify(measurementSet)
  });

  return rp.post(postMeasurementSetOptions).then(function (body) {
 ...
 */
var submitMeasurementSets = function submitMeasurementSets(existingSubmission, submission, baseOptions) {
  var promises = [];
