...
var fileUploaderUtil = require('./file-uploader-util');
 ...
 * @return {Promise}
 */
var fileUploader = function fileUploader(submissionBody, submissionFormat, JWT, baseSubmissionURL, callback) {
  ...
  return fileUploaderUtil.validateSubmission(submissionBody, submissionFormat, baseOptions).then(function (validSubmission) {
    ...
    var postAndPutPromises = fileUploaderUtil.submitMeasurementSets(existingSubmission, validatedSubmission, baseOptions);
